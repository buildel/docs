...
Description | The description of the chat. | N/A| 
API key | OpenAI API key to use for the chat. | N/A| 
Model API type | The API type to use for the chat. | N/A| 
Model | The model to use for the chat. | N/A| 
Endpoint | The endpoint to use for the chat. | N/A| 
Chat memory type | The chat memory type to use for the chat. | N/A| 
...
Prompt template | The template to use for the prompt. Pass `{{input_name:output}}` to use the input value. | N/A
