...
## How to read those docs?


We understand that the topic of AI isn't particularly straightforward. Despite our efforts to simplify the app for ease of use, some aspects might still need further explanation.

For those not quite familiar with such applications, we've prepared a [Guide](/docs/category/guides) that will take you from basic tasks like setting up an organization, through crafting a simple workflow, to creating a really cool AI assistant.
